...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Image              | `<img>` with `src`; optional `alt`, `width`, `height`, `caption`, `thumbhash`, `accent`, `display-width` (integer 10–100, percent of content column), `layout` (`align-left`, `align-right`, `float-left`, `float-right`). | `<img src="/a.jpg" alt="A" caption="Caption" layout="float-right" display-width="40" />`                                                                                               |
