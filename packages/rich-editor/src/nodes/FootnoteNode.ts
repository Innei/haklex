...
import { FOOTNOTE_NODE_KEY } from '../types/renderer-keys';
...
export class FootnoteNode extends DecoratorNode<ReactElement> {
  ...
  static importJSON(
    ...
    return $createFootnoteNode(serializedNode.identifier).updateFromJSON(_serializedNode);
  }
  ...
  decorate(_editor: LexicalEditor, _config: EditorConfig): ReactElement {
    return createRendererDecoration(FOOTNOTE_NODE_KEY, FootnoteStaticRenderer, {
      identifier: this.__identifier,
    });
  }
}
