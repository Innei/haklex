...
export const semanticClassNames = {
  ...
  embedAppleMusic: 'rich-embed--apple-music',
  embedSpotify: 'rich-embed--spotify',
...
export const semanticEmbedModifierClass = {
  ...
  'apple-music': semanticClassNames.embedAppleMusic,
  'spotify': semanticClassNames.embedSpotify,
...
export const embedType = styleVariants({
  ...
  'apple-music': { vars: { [embedAccent]: '250, 36, 60' } },
  'spotify': { vars: { [embedAccent]: '29, 185, 84' } },
