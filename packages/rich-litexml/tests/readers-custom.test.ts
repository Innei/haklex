...
describe('custom readers', () => {
  ...
  it('reads <gallery>', () => {
    const nodes = parse('<gallery id="g1" layout="grid"><img src="/a.jpg" alt="A" /><img src="/b.jpg" alt="B" /></gallery>')
  ...
  it('reads <codesnippet>', () => {
    const nodes = parse('<codesnippet id="cs1"><file name="index.ts" lang="ts">export {}</file></codesnippet>')
