...
function TableRowColumnHandlesInner({
  ...
  const updateHandlesFromAnchor = useCallback((anchor?: ActiveAnchor | null) => {
    if (anchor !== undefined) {
    ...
    const cell = (cells[colIndex] ?? cells[0]) as HTMLTableCellElement | undefined;
    if (!cell) {
      activeAnchorRef.current = null;
      setRowHandle((s) => ({ ...s, visible: false }));
      setColHandle((s) => ({ ...s, visible: false }));
  ...
  return (
    <>
      ...
      >
        <button aria-label="Add row" className={css.handleBtn} type="button" onClick={addRowBelow}>
          <Plus size={ICON_SIZE} />
        </button>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" side="right" sideOffset={4}>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className={css.menuItemDestructive} onClick={deleteRow}>
              <Trash2 size={14} />
              Delete row
            </DropdownMenuItem>
          </DropdownMenuContent>
      ...
      >
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" side="bottom" sideOffset={4}>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className={css.menuItemDestructive} onClick={deleteColumn}>
              <Trash2 size={14} />
              Delete column
            </DropdownMenuItem>
          </DropdownMenuContent>
...
export function TableRowColumnHandlesPlugin(): ReactElement {
  ...
  return createPortal(<TableRowColumnHandlesInner editor={editor} />, document.body);
}
