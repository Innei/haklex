...
import { ALERT_ICONS, ALERT_LABELS, AlertRenderer, ALL_TYPES } from './AlertRenderer';
import * as css from './styles.css';

export const AlertEditRenderer: FC<AlertRendererProps> = ({ type, editable, onTypeChange }) => {
          ...
          {ALL_TYPES.map((t) => {
            ...
            return (
              <DropdownMenuItem key={t} onClick={() => onTypeChange(t)}>
                <ItemIcon className={`${css.alertMenuIcon} ${css.alertType({ type: t })}`} />
