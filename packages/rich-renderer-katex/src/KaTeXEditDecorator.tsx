    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className={`${styles.header} ${styles.semanticClassNames.header}`}>
          ...
          >
            <div
              className={`${styles.iconWrap} ${styles.semanticClassNames.iconWrap}`}
            >
              <Terminal size={12} />
            </div>
            <span
              className={`${styles.title} ${styles.semanticClassNames.title}`}
            >
              Math Editor
            </span>
          </div>
          ...
          >
            <span
              className={`${styles.mode} ${styles.semanticClassNames.mode}`}
            >
        ...
        <div
          className={`${styles.bodyScrollArea} ${styles.semanticClassNames.bodyScrollArea}`}
        >
          {/* Editor Tab */}
          {activeTab === 'editor' && (
            <div className={`${styles.body} ${styles.semanticClassNames.body}`}>
              <div
                className={`${styles.field} ${styles.semanticClassNames.field}`}
              >
                <label
                  className={`${styles.label} ${styles.semanticClassNames.label}`}
                >
                  LaTeX Input
                </label>
                <div
                      ...
                      >
                        {group.items.map((snippet) => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              handleInsertSnippet(snippet.template)
                            }
                          >
                            <div
        ...
        <div className={`${styles.footer} ${styles.semanticClassNames.footer}`}>
          <span
            className={`${styles.charCount} ${styles.semanticClassNames.charCount}`}
          >
