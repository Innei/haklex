...
function compileMarkdown(md: string): any {
  return compiler(md, {
    ...
    overrides: {
      ...
      Tabs: (props: any) =>
        createElement('div', { key: props.key, className: 'tabs' }, props.children),
      tab: (props: any) =>
        createElement('div', { key: props.key, className: 'tab' }, props.children),
      tag: (props: any) =>
        createElement('span', { key: props.key, className: 'tag' }, props.children),
    },
    extendsRules: {
